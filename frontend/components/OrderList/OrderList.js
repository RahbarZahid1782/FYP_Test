...
//display details of an order.custom functions for formatting time and date, and uses state and effects to compute and display order details
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.innerRow}>
        ...
        <Text style={styles.secondaryText}>Total Amount : {totalCost}Rs</Text>
      </View>
      <View style={styles.innerRow}>
