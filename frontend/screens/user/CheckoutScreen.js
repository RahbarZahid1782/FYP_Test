      ...
      <ScrollView style={styles.bodyContainer} nestedScrollEnabled={true}>
        ...
        <View style={styles.totalOrderInfoContainer}>
          <View style={styles.list}>
            ...
            <Text style={styles.list}>{totalCost}Rs</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.list}>Delivery</Text>
            <Text style={styles.list}>{deliveryCost}Rs</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.primaryTextSm}>Total</Text>
            <Text style={styles.secondaryTextSm}>
              {totalCost + deliveryCost}Rs
            </Text>
          </View>
        </View>
        ...
        <View style={styles.listContainer}>
          ...
          <View style={styles.list}>
            ...
            <Text style={styles.secondaryTextSm}>+92 3009877917</Text>
          </View>
        </View>
