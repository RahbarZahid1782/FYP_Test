...
const category = [
  {
    ...
    title: "Indoor Plants",
    image: require("../../assets/icons/indoor.png"),
  },
  {
  ...
  },
  {
    ...
    image: require("../../assets/icons/gardeningtools.png"),
  },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBarContainer}>
        ...
        <View style={styles.topbarlogoContainer}>
          ...
          <Text style={styles.toBarText}>BloomEase</Text>
        </View>
        <TouchableOpacity
      ...
      <View style={styles.bodyContainer}>
        ...
        <ScrollView nestedScrollEnabled={true}>
          ...
          <View style={styles.primaryTextContainer}>
            <Text style={styles.primaryText}>Latest Products</Text>
          </View>
          {products.length === 0 ? (
