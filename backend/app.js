...
app.post('/blog/create', authenticateToken, createBlog);
app.get('/blog/search', searchBlog)
app.get('/blog/bytags', blogsByTags)
app.get('/blog/myblogs', authenticateToken, myBlogs)
app.get('/blog/:id', getBlog);
app.put('/blog/update/:blogId', authenticateToken, editBlog)
app.delete('/blog/delete/:blogId', authenticateToken, deleteBlog)
app.put('/blog/addComment/:blogId', authenticateToken, addComment)
app.put('/blog/:blogId/editComment/:commentIndex', authenticateToken, editComment)
app.delete('/blog/:blogId/delete/:commentIndex', authenticateToken, deleteComment)
app.put('/blog/like/:blogId', authenticateToken, handleLikeBlog)
app.put('/blog/dislike/:blogId', authenticateToken, handleDisLikeBlog)
